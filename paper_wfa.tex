...
\input{chapters/parameters}
\input{chapters/dataValidity}
\input{chapters/concept}
\input{chapters/evaluation}
\input{chapters/openChallenges}
...
\bibitem{reviewofassessmenttests1}J. Asimakopulos, Z. Boychuck, D. Sondergaard, V. Poulin, I. Ménard, und N. Korner-Bitensky, 'Assessing executive function in relation to fitness to drive: A review of tools and their ability to predict safe driving', Australian Occupational Therapy Journal, 59 (6), pp. 402-427, 2012
\bibitem{drivingsimulations}J. L. Campos, M. Bédard, und S. Classen, 'Guiding Framework for Driver Assessment Using Driving Simulators', Frontiers in Psychology. 2017
\bibitem{reviewofassessmenttests2}A. Baker, C. A. Unsworth, und N. A. Lannin,
'Determining fitness to drive: A systematic review of the methods and assessments used after mild traumatic brain injury', British Journal of Occupational Therapy, 78 (2), pp. 73-86, 2015
\bibitem{vrapplications}L. Hirsekorn, S. Taylar, 'VR technology applications in determining fitness to drive', Cyberpsychology and Behavior, 1 (4), pp. 385-389, 2009
...
Journal of the American Geriatrics Society, 64 (9), pp. 1904-1917, 2016
\bibitem{sobrietymobiletests}K. Khosravianarab, 'Development of a Mobile Test Suite to Determine the Sobriety of Motorists.', 2015.
\bibitem{fitnesstrackingbajpaj}  A. Bajpai, V. Jilla, V. N. Tiwari, S. M. Venkatesan, und R. Narayanan, 'Quantifiable fitness tracking using wearable devices,' 2015 37th Annual International Conference of the IEEE Engineering in Medicine and Biology Society (EMBC), Milan, 2015
...
\bibitem{activityrecognition} S. Dernbach, B. Das, N. C. Krishnan, B. L. Thomas, und D. J. Cook, 'Simple and Complex Activity Recognition through Smart Phones', 2012 Eighth International Conference on Intelligent Environments, Guanajuato, 2012
...
\bibitem{reviewwearablesensors} S. Patel, H. Park
