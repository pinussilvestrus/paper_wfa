...
\todo[inline]{Aufzählen Sensoren }

\todo[inline]{Am Ende zum Ergebnis kommen, dass Zweiteilung sinnvoll ist (siehe Zwischenpräsentation), Hier würde sich die Tabelle der Parameter - Messung/Test aus der Recherche gut eignen, aber aufspalten in zwei Tabellen (Smarttracking und App-Tests)!}
